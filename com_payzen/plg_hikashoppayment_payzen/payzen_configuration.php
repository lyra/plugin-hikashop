        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a><b><?php echo \Lyranetwork\Payzen\Sdk\Form\Api::formatSupportEmails("https://payzen.io/fr-FR/support/", JText::_('PAYZEN_CLICK_HERE')); ?></b></a>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="data[payment][payment_params][payzen_payment_cards][]" class="inputbox" multiple="multiple" size="8" id="payzen_payment_cards" style="width: 122px;" >
                            ...
                            foreach (\Lyranetwork\Payzen\Sdk\Form\Api::getSupportedCardTypes() as $code => $label) {
...
<tr>
    <td colspan="2">
        <fieldset>
            <legend><?php echo JText::_('PAYZEN_CUSTOM_3DS'); ?></legend>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <?php echo HTMLHelper::_('select.booleanlist', 'data[payment][payment_params][payzen_redirect_enabled]' , '', @$params->payzen_redirect_enabled); ?><br />
